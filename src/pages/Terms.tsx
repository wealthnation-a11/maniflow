    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="max-w-3xl mx-auto px-4 py-16">
        ...
        <div className="space-y-4 text-sm text-muted-foreground">
          ...
          <p>By using Maniflow, you agree to these terms. If you don't agree, please don't use the service.</p>
          <h2 className="font-heading text-lg font-semibold text-foreground pt-4">2. Service Description</h2>
          <p>Maniflow provides AI-powered business automation including unified messaging, order capture, and payment link generation across social platforms.</p>
          ...
          <p>Subscription fees are billed monthly. Payment processing via Paystack or Flutterwave is subject to their respective terms. Maniflow charges no additional transaction fees.</p>
          <h2 className="font-heading text-lg font-semibold text-foreground pt-4">5. AI Disclaimer</h2>
          <p>AI-generated replies are designed to be helpful and accurate, but we recommend monitoring conversations. Maniflow is not liable for AI response errors.</p>
