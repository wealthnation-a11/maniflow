    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="max-w-3xl mx-auto px-4 py-16">
        ...
        <div className="space-y-4 text-sm text-muted-foreground">
          ...
          <p>You can request access to, correction of, or deletion of your data at any time by contacting us at privacy@maniflow.co.</p>
          <h2 className="font-heading text-lg font-semibold text-foreground pt-4">6. Contact</h2>
          <p>For privacy-related inquiries, email us at <span className="text-primary">privacy@maniflow.co</span>.</p>
        </div>
      </div>
    </div>
  );
