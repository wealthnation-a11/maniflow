  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="max-w-3xl mx-auto px-4 py-16">
        <h1 className="font-heading text-3xl md:text-4xl font-bold mb-6">About Maniflow</h1>
        <div className="space-y-4 text-muted-foreground">
          <p>Maniflow is the AI-powered business automation platform built for small businesses across Africa and the world. Many channels, one flow — we connect your social platforms — WhatsApp, Instagram, and Facebook — into one powerful dashboard.</p>
          ...
          <h2 className="font-heading text-xl font-semibold text-foreground pt-4">Why Maniflow?</h2>
    ...
    <footer className="border-t py-8 px-4">
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4 text-sm text-muted-foreground">
        <div className="flex items-center gap-2">
          <ManiflowLogo className="h-5 w-5" />
          <span className="font-heading font-semibold text-foreground">Maniflow</span>
        </div>
